...
public class MineSweeper {
	...
	/**
	 * getInput is used to get the user input for the game.
	 * Also it checks the range for the input
	 * 
	 * @param number
	 * @param msg
	 * @return
	...
	/**
	 * getUserSelection is used to get the user input for cell in the play
	 * 
	 * @param number
	 * @param s
	 * @return
	...
	/**
	 * mineSweeperStart is the main play area for the game
	 * 
	 * @param gridSize
	 * @param mines
	 */
	...
	/**
	 * playGame is used to play for reveling and continuation of the game
	 * 
	 * @param cells
	 * @param mines
	 */
	...
	/**
	 * setUpGame is used to prepare the game with initial setUp
	 * 
	 * @param gridSize
	 * @param mines
	 * @return
	...
	/**
	 * initCells is used to initialize the cells with adjacent and current cell value
	 * 
	 * @param cells
	 */
	...
	/**
	 * getCellValue is used to get the current cell value
	 * 
	 * @param i
	 * @param j
	 * @param cells
	...
	/**
	 * fillCells is used to fill the cell with random value and mines as per user selection
	 * 
	 * @param size
	 * @param maxMines
	 * @return
	...
	/**
	 * expose method is for opening the cell
	 * 
	 * @param i
	 * @param j
	 * @param cells
	...
	/**
	 * printCells method is used to print game board
	 * 
	 * @param cells
	 */
	...
	/**
	 * getAlphabets is method used to provide the list of Characters
	 * 
	 * @param number
	 * @return
	 */
